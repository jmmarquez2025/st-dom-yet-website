...
export const friars = [
  { id: "frassati-davis", name: "Fr. Frassati Davis, O.P.", role: "pastor", photo: `${B}photos/davis_frassati.jpg` },
  { id: "charles-rooney", name: "Fr. Charles Marie Rooney, O.P.", role: "associate", photo: `${B}photos/rooney_charles.jpg` },
